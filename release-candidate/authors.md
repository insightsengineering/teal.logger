...
Source:
[`DESCRIPTION`](https://github.com/insightsengineering/teal.logger/blob/v0.4.1-rc1/DESCRIPTION)

Kaledkowski D, Pagacz K (2025). *teal.logger: Logging Setup for the
'teal' Family of Packages*. R package version 0.4.1,
